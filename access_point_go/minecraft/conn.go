...
// DisconnectMessage 返回服务器通过 Disconnect 数据包发送的断开连接消息(如踢出/封禁原因)。
// 当连接未因 Disconnect 断开时返回空字符串。PocketTerm 接入点用它向宿主上报踢出原因。
func (conn *Conn) DisconnectMessage() string {
